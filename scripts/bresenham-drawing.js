...
var Bresenham;
(function (Bresenham) {
    var GridCalculator = /** @class */ (function () {
...
(function (Bresenham) {
    ...
    /// for the reference...
    /// </remarks>
    var BresenhamRasterizer = /** @class */ (function () {
...
(function (Bresenham) {
    ...
    var PreviewController = /** @class */ (function () {
        ...
        PreviewController.prototype.processMouseLeave = function (self, _) {
            if (!self._isMousePressed) {
                return;
            }
        ...
        PreviewController.prototype.drawPreview = function () {
            ...
            this.painter.rasterizeLine(this.column0, this.row0, this.column1, this.row1, function (x, y) {
                ...
                /*column*/ x, 
                /*row*/ y, 
                /*value*/ _this.model.getCellValue(x, y));
...
(function (Bresenham) {
    var DrawingController = /** @class */ (function () {
        function DrawingController(painter) {
            this.painter = painter;
        }
...
(function (Bresenham) {
    var Application = /** @class */ (function () {
        ...
        Application.prototype.initWithSharedCanvas = function () {
            ...
            this.drawingController = new Bresenham.DrawingController(painter);
            new Bresenham.PreviewController(calculator, model, painter, canvas, function (pc) {
...
//# sourceMappingURL=bresenham-drawing.js.map